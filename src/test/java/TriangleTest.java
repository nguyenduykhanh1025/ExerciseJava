...
public class TriangleTest {
    ...
    public void test_getType() {
        assertEquals(new Triangle(4, 12, -11, 2, 13, -4).getType(), typeShape.NORMAL);
    }

    @Test
    public void test_getType2() {
        assertEquals(new Triangle(4, 11, -11, 2, 13, -4).getType(), typeShape.RIGHT_TRIANGLE);
        assertEquals(new Triangle(4, 11, 13, -4, -11, 2).getType(), typeShape.RIGHT_TRIANGLE);
        assertEquals(new Triangle(13, -4, -11, 2, 4, 11).getType(), typeShape.RIGHT_TRIANGLE);
        assertEquals(new Triangle(13, -4, 4, 11, -11, 2).getType(), typeShape.RIGHT_TRIANGLE);
        assertEquals(new Triangle(-11, 2, 4, 11, 13, -4).getType(), typeShape.RIGHT_TRIANGLE);
        assertEquals(new Triangle(-11, 2, 13, -4, 4, 11).getType(), typeShape.RIGHT_TRIANGLE);
    }

    @Test
    public void test_getType3() {
        assertEquals(new Triangle(-1, 1, 1, 3, 2, 0).getType(), typeShape.ISOSCELES_TRIANGLE);
        assertEquals(new Triangle(-1, 1, 2, 0, 1, 3).getType(), typeShape.ISOSCELES_TRIANGLE);
        assertEquals(new Triangle(1, 3, -1, 1, 2, 0).getType(), typeShape.ISOSCELES_TRIANGLE);
        assertEquals(new Triangle(1, 3, 2, 0, -1, 1).getType(), typeShape.ISOSCELES_TRIANGLE);
        assertEquals(new Triangle(2, 0, -1, 1, 1, 3).getType(), typeShape.ISOSCELES_TRIANGLE);
        assertEquals(new Triangle(2, 0, 1, 3, -1, 1).getType(), typeShape.ISOSCELES_TRIANGLE);
    }

    @Test
    public void test_getType4() {
        assertEquals(new Triangle(2, 3, -1, -3, 0, -1).getType(), typeShape.INVALID);
        assertEquals(new Triangle(2, 3, 0, -1, -1, -3).getType(), typeShape.INVALID);
        assertEquals(new Triangle(-1, -3, 2, 3, 0, -1).getType(), typeShape.INVALID);
        assertEquals(new Triangle(-1, -3, 0, -1, 2, 3).getType(), typeShape.INVALID);
        assertEquals(new Triangle(0, -1, 2, 3, -1, -3).getType(), typeShape.INVALID);
        assertEquals(new Triangle(0, -1, -1, -3, 2, 3).getType(), typeShape.INVALID);
    }
